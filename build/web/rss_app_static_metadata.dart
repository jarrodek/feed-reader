...
import 'package:rss_app/component/star/star.dart' as import_9;
import 'package:rss_app/component/feed_list/feed_list.dart' as import_10;
import 'package:rss_app/component/app-header/app-header.dart' as import_11;
import 'package:rss_app/component/data_handler/data_handler.dart' as import_12;
import 'package:rss_app/component/post/post.dart' as import_13;
import 'package:rss_app/formatter/text_formatter.dart' as import_14;
import 'package:rss_app/component/menu/menu.dart' as import_15;
import 'package:rss_app/component/pubdate/pubdate.dart' as import_16;
import 'package:rss_app/decorator/app-icon.dart' as import_17;
import 'package:rss_app/component/feed_entries/feed_entries.dart' as import_18;
import 'package:rss_app/formatter/date_formatter.dart' as import_19;
import 'package:rss_app/component/lists/list_article.dart' as import_20;
import 'package:rss_app/component/menu/menu-item.dart' as import_21;
...
final Map<Type, Object> typeAnnotations = {
  ...
  import_10.FeedListComponent: const [
  ...
  import_11.AppHeaderComponent: const [
  ...
  import_14.TruncateFilter: const [
    const import_1.Formatter(name: 'truncate'),
  ],
  import_15.MenuComponent: const [
  ...
  import_16.PubdateComponent: const [
  ...
  import_17.AppIcon: const [
    const import_1.Decorator(selector: '[icon]'),
  ],
  import_18.FeedEntriesComponent: const [
  ...
  import_19.RelativeDateFilter: const [
    const import_1.Formatter(name: 'relativedate'),
  ],
  import_19.RelativeDayFilter: const [
    const import_1.Formatter(name: 'relativeday'),
  ],
  import_20.ListArticleComponent: const [
  ...
  import_21.MenuItemDecorator: const [
    const import_1.Decorator(selector: 'menu-item'),
  ],
  import_22.EntriesListComponent: const [
