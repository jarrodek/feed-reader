...
import 'package:rss_app/decorator/app-image.dart' as import_30;
import 'package:rss_app/component/star/star.dart' as import_31;
import 'package:rss_app/component/feed_list/feed_list.dart' as import_32;
import 'package:rss_app/service/analytics.dart' as import_33;
import 'package:rss_app/component/app-header/app-header.dart' as import_34;
import 'package:rss_app/service/events_observer.dart' as import_35;
import 'package:rss_app/component/data_handler/data_handler.dart' as import_36;
import 'package:rss_app/component/tag_entries/tag_entries.dart' as import_37;
import 'package:rss_app/component/post/post.dart' as import_38;
import 'package:rss_app/formatter/text_formatter.dart' as import_39;
import 'package:rss_app/component/menu/menu.dart' as import_40;
import 'package:rss_app/component/pubdate/pubdate.dart' as import_41;
import 'package:rss_app/decorator/app-icon.dart' as import_42;
import 'package:rss_app/component/feed_entries/feed_entries.dart' as import_43;
import 'package:rss_app/formatter/date_formatter.dart' as import_44;
import 'package:rss_app/component/lists/list_article.dart' as import_45;
import 'package:rss_app/component/menu/menu-item.dart' as import_46;
import 'package:rss_app/component/app_footer/app_footer.dart' as import_47;
import 'package:rss_app/component/app_settings/app_settings.dart' as import_48;
import 'package:rss_app/component/lists/entries_lists.dart' as import_49;
...
final Key _KEY_AnalyticsService = new Key(import_33.AnalyticsService);
final Key _KEY_AppComm = new Key(import_26.AppComm);
final Key _KEY_AppEvents = new Key(import_35.AppEvents);
...
final Map<Type, Function> typeFactories = <Type, Function>{
  ...
  import_28.EntriesListFormatter: () => new import_28.EntriesListFormatter(),
  import_29.ImageService: (a1) => new import_29.ImageService(a1),
  import_30.AppImage: (a1, a2) => new import_30.AppImage(a1, a2),
  import_31.StarringComponent: () => new import_31.StarringComponent(),
  import_32.FeedListComponent: (a1, a2) => new import_32.FeedListComponent(a1, a2),
  import_33.AnalyticsService: () => new import_33.AnalyticsService(),
  import_34.AppHeaderComponent: (a1, a2, a3, a4, a5) => new import_34.AppHeaderComponent(a1, a2, a3, a4, a5),
  import_35.AppEvents: () => new import_35.AppEvents(),
  import_36.DataHandlerComponent: (a1, a2, a3) => new import_36.DataHandlerComponent(a1, a2, a3),
  import_37.TagEntriesComponent: (a1, a2, a3) => new import_37.TagEntriesComponent(a1, a2, a3),
  import_38.PostComponent: (a1, a2, a3, a4) => new import_38.PostComponent(a1, a2, a3, a4),
  import_39.TruncateFilter: () => new import_39.TruncateFilter(),
  import_40.MenuComponent: () => new import_40.MenuComponent(),
  import_41.PubdateComponent: () => new import_41.PubdateComponent(),
  import_42.AppIcon: (a1) => new import_42.AppIcon(a1),
  import_43.FeedEntriesComponent: (a1, a2) => new import_43.FeedEntriesComponent(a1, a2),
  import_44.RelativeDateFilter: () => new import_44.RelativeDateFilter(),
  import_44.RelativeDayFilter: () => new import_44.RelativeDayFilter(),
  import_45.ListArticleComponent: (a1, a2, a3) => new import_45.ListArticleComponent(a1, a2, a3),
  import_46.MenuItemDecorator: (a1) => new import_46.MenuItemDecorator(a1),
  import_47.AppFooterComponent: () => new import_47.AppFooterComponent(),
  import_48.AppSettingsComponent: (a1) => new import_48.AppSettingsComponent(a1),
  import_49.EntriesListComponent: (a1, a2) => new import_49.EntriesListComponent(a1, a2),
...
final Map<Type, List<Key>> parameterKeys = {
  ...
  import_28.EntriesListFormatter: const[],
  import_29.ImageService: [_KEY_Http],
  import_30.AppImage: [_KEY_Element, _KEY_ImageService],
  import_31.StarringComponent: const[],
  import_32.FeedListComponent: [_KEY_QueryService, _KEY_AnalyticsService],
  import_33.AnalyticsService: const[],
  import_34.AppHeaderComponent: [_KEY_QueryService, _KEY_Router, _KEY_AppComm, _KEY_AppEvents, _KEY_AnalyticsService],
  import_35.AppEvents: const[],
  import_36.DataHandlerComponent: [_KEY_RouteProvider, _KEY_Router, _KEY_QueryService],
  import_37.TagEntriesComponent: [_KEY_QueryService, _KEY_RouteProvider, _KEY_AnalyticsService],
  import_38.PostComponent: [_KEY_RouteProvider, _KEY_QueryService, _KEY_ImageService, _KEY_AnalyticsService],
  import_39.TruncateFilter: const[],
  import_40.MenuComponent: const[],
  import_41.PubdateComponent: const[],
  import_42.AppIcon: [_KEY_Element],
  import_43.FeedEntriesComponent: [_KEY_QueryService, _KEY_AnalyticsService],
  import_44.RelativeDateFilter: const[],
  import_44.RelativeDayFilter: const[],
  import_45.ListArticleComponent: [_KEY_QueryService, _KEY_Router, _KEY_AnalyticsService],
  import_46.MenuItemDecorator: [_KEY_Element],
  import_47.AppFooterComponent: const[],
  import_48.AppSettingsComponent: [_KEY_AnalyticsService],
  import_49.EntriesListComponent: [_KEY_QueryService, _KEY_AnalyticsService],
