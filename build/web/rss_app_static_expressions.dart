...
final Map<String, FieldGetter> getters = {
  ...
  r"title": (o) => o.title,
  r"unreadCounter": (o) => o.unreadCounter,
  r"postsMap": (o) => o.postsMap,
  ...
  r"prevEntry": (o) => o.prevEntry,
  r"nextEntry": (o) => o.nextEntry,
  r"entry": (o) => o.entry,
...
final Map<String, FieldSetter> setters = {
  ...
  r"unreadCounter": (o, v) => o.unreadCounter = v,
  r"postsMap": (o, v) => o.postsMap = v,
  ...
  r"prevEntry": (o, v) => o.prevEntry = v,
  r"nextEntry": (o, v) => o.nextEntry = v,
